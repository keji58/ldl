...
throw o.stack&&console&&console.error&&console.error("[TryCatch]"+o.stack),l&&window.__moon_report&&(window.__moon_report([{
offset:g,
...
throw o.stack&&console&&console.error&&console.error("[TryCatch]"+o.stack),l&&window.__moon_report&&(window.__moon_report([{
offset:v,
log:"listener_error;host:"+top.location.host,
e:o
}]),r(p)),o;
}
},a.moon_lid=j,O[j]=t,j++,o.call(i,e,t,n);
};
}
function s(o){
return function(e,t,n){
if("undefined"==typeof n)var n=!1;
var r=this;
return t=O[t.moon_lid],o.call(r,e,t,n);
};
}
var l,u,f,m,d,p,w=/MicroMessenger/i.test(navigator.userAgent),_=window.define,h=0,v=2,g=9,y=10;
if(window.__initCatch=function(o){
l=o.idkey,u=o.startKey||0,f=o.limit,m=o.reportOpt||"",d=o.extinfo||"";
},window.__moon_report=function(o){
if(/mp\.weixin\.qq\.com/.test(location.href)&&!(Math.random()>.5)&&w&&top==window&&(t(o)&&(o=[o]),
e(o)&&""!=l)){
var r="",a=[],c=[],s=[],m=[];
if("number"!=typeof f)for(var d=0;d<o.length;d++){
var p=o[d]||{};
a[d]="[moon]"+l+"_"+u+";"+p.log+";"+n(p.e||{})||"",c[d]=u,s[d]=1;
}else for(var d=0;d<o.length;d++){
var p=o[d]||{};
if(!(p.offset>f)&&"number"==typeof p.offset){
var _=u+p.offset;
a[d]="[moon]"+l+"_"+_+";"+p.log+";"+n(p.e||{})||"",c[d]=_,s[d]=1;
}
}
for(var h=0;h<c.length;h++)m[h]=l+"_"+c[h]+"_"+s[h],r=r+"&log"+h+"="+a[h];
m.length>0&&i("idkey="+m.join(";")+"&lc="+a.length+r);
}
},window.setTimeout=a(window.setTimeout),window.setInterval=a(window.setInterval),
Math.random()<.001&&window.Document&&window.HTMLElement){
var O={},j=0;
...
if((/ip(hone|ad|od)/i.test(L)||/android/i.test(L))&&!/windows phone/i.test(L)&&window.localStorage&&window.localStorage.setItem){
var b=window.localStorage.setItem,q=0;
window.localStorage.setItem=function(o,e){
if(!(q>=10))try{
b.call(window.localStorage,o,e);
}catch(t){
...
load:function(o){
if(!o||o.length<=0)return seajs.combo_status=seajs.COMBO_LOADED,seajs.run(),void console.debug("[moon]load js complete, all in cache, cost time : 0ms, total count : "+i.mod_num+", hit num: "+i.hit_num);
...
if(t++,t==o.length){
var e=+new Date-n;
seajs.combo_status=seajs.COMBO_LOADED,seajs.run(),console.debug("[moon]load js complete, total count : "+i.mod_num+", hit num: "+i.hit_num+", use time : "+e+"ms");
}
});
});
},
...
var n=new Error(t);
console.error("moon load js error : "+o+", error -> "+n.toString()),window.__moon_report([{
offset:r,
